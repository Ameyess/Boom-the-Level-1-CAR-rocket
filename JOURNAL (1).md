...
# 5/12/2026 10 PM - Final touches Mk4

_Time spent: 1.5h_

In today's session (final session before build, hopefully), I worked on the reviewers' feedback.
![image](https://stasis.hackclub-assets.com/images/1778621315843-hz265c.png)
...
![image](https://stasis.hackclub-assets.com/images/1778622202178-og81d0.png)
The Simulation folder holds the various simulations I did on trajectory and stability.
![image](https://stasis.hackclub-assets.com/images/1778622269304-lfabou.png)
The Firefly folder holds the manual for my altimeter module as well as the wiring diagram for it.
![image](https://stasis.hackclub-assets.com/images/1778622308460-0kyg9x.png)
![image](https://stasis.hackclub-assets.com/images/1778622317928-2cc1nb.png)
...
# 5/7/2026 11 PM - Final touches Mk3
...
# 5/3/2026 9 PM - Final touches Mk2

_Time spent: 1h_

In this session, I worked on updating the model to incorporate the feedback from the review.
![image](https://stasis.hackclub-assets.com/images/1777842665016-jdf862.png)
I went through each point raised and worked on getting the necessary updates done. I also uploaded the BOM as a CSV file to GitHub, which had been flagged as missing.
...
# 4/12/2026 10 AM - Final touches

_Time spent: 0.5h_

2026-04-12

Today I worked on the final touches for Boom. There was not much to CAD or research, so I spent some time exploring possible decals and logos for the rocket. Apart from that, I also worked on some miscellaneous things, such as fixing the assembly and addressing other minor issues. Overall, I am happy with how the design turned out, and I think it will fly great and hopefully reach the speeds I am aiming for. I also sliced the nose cone and fins, so they are ready to print. For the fins, I created a technical drawing so they can be sent to the CNC machine at my robotics team.


![image](https://stasis.hackclub-assets.com/images/1776047640300-nw635x.png)


![Screenshot 2026-04-12 at 6.34.30 AM](https://stasis.hackclub-assets.com/images/1775990074637-m7ui1q.png)
...
![Screenshot 2026-04-12 at 6.31.32 AM](https://stasis.hackclub-assets.com/images/1775989898891-2orets.png)

![image](https://stasis.hackclub-assets.com/images/1776047640300-nw635x.png)
![image](https://stasis.hackclub-assets.com/images/1775990074637-m7ui1q.png)
![image](https://stasis.hackclub-assets.com/images/1775989898891-2orets.png)

# 4/12/2026 2 AM - Worked on CAD

_Time spent: 0.5h_

2026-04-11

Today's session on Boom was a CAD-focused one. The main tasks were tidying up the existing components, chamfering the edges of the fins, and assigning materials and weights to the parts. It is important to get these items filled out before running simulations, as mass and aerodynamics do play a role in the overall performance of the rocket. I also modeled a few miscellaneous bits and pieces that hadn't been addressed yet, such as the eye bolts. I also added the pilot holes for the altimeter. Today's session went on without a hassle and was smooth. Next session should be the final push to wrap up the CAD and get the design ready for review.
![Screenshot 2026-04-11 at 10.38.29 PM](https://stasis.hackclub-assets.com/images/1775961521337-rrh1gb.png)


![image](https://stasis.hackclub-assets.com/images/1775961069785-xi5ooz.png)


![Screenshot 2026-04-11 at 10.29.55 PM](https://stasis.hackclub-assets.com/images/1775961006138-ugcw6l.png)

![image](https://stasis.hackclub-assets.com/images/1775961521337-rrh1gb.png)
![image](https://stasis.hackclub-assets.com/images/1775961069785-xi5ooz.png)
![image](https://stasis.hackclub-assets.com/images/1775961006138-ugcw6l.png)

# 4/10/2026 9 PM - Worked on avionics and CAD

_Time spent: 1h_

2026-04-10

Today I continued working on Boom and decided on the altimeter debate from last session...
The goal of this session was to finalize the altimeter module and then add and modify the CAD to accommodate it.
...
![Screenshot 2026-04-10 at 2.47.29 PM](https://stasis.hackclub-assets.com/images/1775846864774-xfvpg8.png)

![Screenshot 2026-04-10 at 2.47.59 PM](https://stasis.hackclub-assets.com/images/1775846892743-yw7a7j.png)

![image](https://stasis.hackclub-assets.com/images/1775846864774-xfvpg8.png)
![image](https://stasis.hackclub-assets.com/images/1775846892743-yw7a7j.png)

# 4/9/2026 9 PM - Worked on MORE cad (lol), Avionics, and shtuff :)
...
![image](https://stasis.hackclub-assets.com/images/1775771408626-p774xy.png)

![image](https://stasis.hackclub-assets.com/images/1775766862071-91of3f.png)

![image](https://stasis.hackclub-assets.com/images/1775766875120-gckhzx.png)

![image](https://stasis.hackclub-assets.com/images/1775771376869-2crjcb.png)

![image](https://stasis.hackclub-assets.com/images/1775771384794-fzgiu2.png)
...
# 4/8/2026 2 PM - Worked on CAD and Research

_Time spent: 2h_

2026-04-08

Today I continued working on the payload section of Boom, though this session ended up being more of a research detour than I had planned for it to be. Coming off of last journal, I had originally planned to confirm the physical specs of the GPS and ESP32 modules and get them properly modeled into the CAD, but that didn't happen...

Once I started pricing everything out, I realized that the module would have cost way too much. The GPS Neo-6M and ESP32 combo seemed like a solid, cheap solution, but dedicated altimeter modules on top of that pushed the cost too high. 

Instead of sticking with the ESP 32 route, I started looking at alternatives. One strong option is a imple Arduino Nano paired with a BMP280 barometric pressure sensor, which reads altitude by detecting changes in atmospheric pressure. This has been proven by many other DIY rockets. The whole setup should cost around $20 USD, which wouldn't push the budget too far. This will cover altitude; however, I still need to figure out the GPS portion and how to log the data. 

On the other side of the session, I shifted over to CAD and started working on the motor geometry. I found the official motor assembly drawing, which gave me the key dimensions I needed. Using that as a reference, I was able to model it out in CAD and create a rough outline of what the rocket engine might look like. I still want to double-check with real images and blueprints what the exact dimensions of the rocket motor are. Overall, today's journal was a lot of CAD and researching. 
...
![Screenshot 2026-04-08 at 9.01.33 AM](https://stasis.hackclub-assets.com/images/1775653298319-0485jj.png)


![Screenshot 2026-04-08 at 9.19.16 AM](https://stasis.hackclub-assets.com/images/1775654368092-sjhjpc.png)

![Screenshot 2026-04-08 at 8.48.23 AM](https://stasis.hackclub-assets.com/images/1775652514886-e82cog.png)



![Screenshot 2026-04-08 at 9.14.08 AM](https://stasis.hackclub-assets.com/images/1775654053613-pmx9ey.png)

![image](https://stasis.hackclub-assets.com/images/1775653298319-0485jj.png)
![image](https://stasis.hackclub-assets.com/images/1775654368092-sjhjpc.png)
![image](https://stasis.hackclub-assets.com/images/1775652514886-e82cog.png)
![image](https://stasis.hackclub-assets.com/images/1775654053613-pmx9ey.png)

# 4/7/2026 7 PM - Worked on adding more details to the CAD and researching parts

_Time spent: 1.5h_

2026–04–07

Today I worked on the payload portion of Boom, the L1 rocket. This session was a mix of both CAD and research for various components and parts of the rockets. However, there are still uncertainties to solve. On the research side, I landed on a GPS solution: the Pocket-GPS design using a GPS Neo-6M module paired with an ESP32. This should allow for a cheap and reliable GPS solution. It can display altitude, latitude, longitude, speed, and satellite count, which covers everything needed to track the rocket. I need to research how to send the information back to a server to track the rocket's position. I also started sizing out the payload bay compartments around these components and looked into mounting and fastener options for securing everything inside the bay. The main roadblock that I faced was the uncertainty around specific dimensions and specs of the fasteners and parts. The GPS solution gives me some guidance; however, I still need to work out the specific dimensions and specifications of the payload bay. I also need to keep in mind the weight that this will add and how it will affect the rocket. Without the exact measurements of the modules (GPS), most of the modeling still feels like an estimate until those numbers are confirmed. Overall, this session was productive in terms of researching possible solutions; however, there are still some dimensions needed for the model to be fully completed. Next session, I will confirm the physical specs of the GPS and ESP32 modules and get them properly modeled into the CAD.




![Screenshot 2026-04-07 at 3.10.52 PM](https://stasis.hackclub-assets.com/images/1775589056411-u80xar.png)

![Screenshot 2026-04-07 at 3.11.12 PM](https://stasis.hackclub-assets.com/images/1775589078229-ke28qy.png)

![Screenshot 2026-04-07 at 3.11.26 PM](https://stasis.hackclub-assets.com/images/1775589091319-eob6qq.png)

![Screenshot 2026-04-07 at 3.17.09 PM](https://stasis.hackclub-assets.com/images/1775589435167-g2a611.png)

![image](https://stasis.hackclub-assets.com/images/1775589056411-u80xar.png)
![image](https://stasis.hackclub-assets.com/images/1775589078229-ke28qy.png)
![image](https://stasis.hackclub-assets.com/images/1775589091319-eob6qq.png)
![image](https://stasis.hackclub-assets.com/images/1775589435167-g2a611.png)

# 4/6/2026 11 PM - Worked on refining the L1 Rocket and researching parts
...
![image](https://stasis.hackclub-assets.com/images/1775351929076-qvdnq1.png)

![image](https://stasis.hackclub-assets.com/images/1775351992789-42fk6q.png)

![image](https://stasis.hackclub-assets.com/images/1775352009674-fvvsb0.png)
